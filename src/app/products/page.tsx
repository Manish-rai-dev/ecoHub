...
export const metadata: Metadata = {
  ...
  description:
    'Browse all 12 SKUs of biodegradable bagasse tableware — bowls, round plates, and compartment plates. GST-inclusive pricing from ₹0.85/pc. Min. order 1 box per SKU.',
}
      ...
      <section className="bg-brand-primary py-12 text-white md:py-16">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <p className="mt-4 max-w-2xl text-brand-text-on-green">
            ...
            plates. All prices GST inclusive, FOR terms. Enquire on WhatsApp for availability and
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mb-8 flex items-start gap-3 rounded-lg border border-brand-accent/30 bg-brand-light p-4">
            ...
            <p className="text-sm text-brand-primary">
              All prices inclusive of GST &amp; FOR. Weights approx ±10%. Min. order: 1 box per SKU.
            </p>
          </div>
          <ProductGrid />
        </div>
