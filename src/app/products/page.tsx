...
export const metadata: Metadata = {
  ...
  description:
    'Browse all 14 SKUs of biodegradable bagasse tableware — bowls, plain plates, compartment trays, and specialty serveware. Min. order 1 box per SKU. Enquire for a quote.',
}
